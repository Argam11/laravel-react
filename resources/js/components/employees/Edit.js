 ...
 class Edit extends Component {
    ...
    componentDidMount () {
        if(localStorage.getItem('token')) {
            axios.get(`/api/employees/${this.id}`, this.config).then(response => {
                this.setState({
                    companies: response.data.original.companies,
                    first_name: response.data.original.employee.first_name,
                    last_name: response.data.original.employee.last_name,
                    company_id: response.data.original.employee.company_id,
                    email: response.data.original.employee.email,
                    phone: response.data.original.employee.phone
                })
            });
        }
    }
